...
class Converger : public ::sophon_stream::framework::Element {
 public:
  ...
  static constexpr const char* CONFIG_INTERNAL_DEFAULT_PORT_FILED =
      "default_port";
  static constexpr const char* CONFIG_INTERNAL_MAX_WAIT_MS_FIELD =
      "max_wait_ms";
 ...
 private:
  ...
  std::unordered_map<int, std::unordered_map<int, std::chrono::steady_clock::time_point>>
      mCandidateInsertTimes;
