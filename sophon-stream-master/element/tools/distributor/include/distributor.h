...
class Distributor : public ::sophon_stream::framework::Element {
 public:
  ...
  static constexpr const char* CONFIG_INTERNAL_DETECTED_CROP_LEFT_RATIO_FIELD =
      "detected_crop_left_ratio";
  static constexpr const char* CONFIG_INTERNAL_DETECTED_CROP_TOP_RATIO_FIELD =
      "detected_crop_top_ratio";
  static constexpr const char* CONFIG_INTERNAL_DETECTED_CROP_RIGHT_RATIO_FIELD =
      "detected_crop_right_ratio";
  static constexpr const char* CONFIG_INTERNAL_DETECTED_CROP_BOTTOM_RATIO_FIELD =
      "detected_crop_bottom_ratio";

 private:
  bool makeSubObjectMetadata(
  ...
  bool makeSubFaceObjectMetadata(
      std::shared_ptr<common::ObjectMetadata> obj,
  ...
  int get_rect(bmcv_rect_t& rect, int* points, int frame_width, int frame_height);
  ...
  double mDetectedCropLeftRatio = 0.0;
  double mDetectedCropTopRatio = 0.0;
  double mDetectedCropRightRatio = 1.0;
  double mDetectedCropBottomRatio = 1.0;
};
